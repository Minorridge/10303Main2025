...
public final class Constants {
  public class LimelightConstants {
    ...
    public static final double kStrafeP = 0.05;
    public static final double kStrafeI = 0.0;
    public static final double kStrafeD = 0.0;

    // PID Profile Constraints
    public static final double kDriveMaxV = .1; // Max velocity for drive PID
    public static final double kDriveMaxA = .1; // Max acceleration for drive PID

    public static final double kTurnMaxV = .1; // Max velocity for turn PID
    public static final double kTurnMaxA = .1; // Max acceleration for turn PID

    public static final double kStrafeMaxV = .1; // Max velocity for strafe PID
    public static final double kStrafeMaxA = .1; // Max acceleration for strafe PID

    // Alignment Constants
    public static final double kTargetDistance = 0.635; // Target distance from the target (meters)
    public static final double kDistanceTolerance = 0.08; // Tolerance for distance error (meters)
    public static final double kAngleTolerance =
        Math.toRadians(2); // Tolerance for angle error (radians)
    public static final double kStrafeTolerance = 0.08; // Tolerance for strafe error (meters)

    // Speed Limits
    public static final double kMaxDriveSpeed = 1.0; // Max drive speed (meters/second)
    public static final double kMaxTurnSpeed = 2.0; // Max turn speed (radians/second)
    public static final double kMaxStrafeSpeed = 1.0; // Max strafe speed (meters/second)

    // Timeout
    public static final double kTimeoutSeconds = 5.0; // Timeout for auto-alignment (seconds)
  }
